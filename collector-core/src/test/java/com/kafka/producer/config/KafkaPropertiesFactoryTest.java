...
class KafkaPropertiesFactoryTest {
  ...
  @Test
  void createsEscapedJaasAndSeparateProperties() throws Exception {
    ...
    input.setProperty("kafka.sasl.username", "u\"ser");
    input.setProperty("kafka.sasl.password", "p\\ass");
  ...
  @Test
  void kafkaProducerAcceptsSslKeyPasswordWithoutStores() throws Exception {
    Properties input = TestConfigFactory.base(temp);

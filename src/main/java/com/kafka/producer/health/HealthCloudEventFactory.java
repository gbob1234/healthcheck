...
public final class HealthCloudEventFactory {
    ...
    private Map<String, Object> kafkaInfo(HealthSnapshot s) { Map<String, Object> m = new LinkedHashMap<String, Object>(); m.put("topicName", config.imageProducer.topic); m.put("lastSendSuccessAt", text(s.lastImageSendSuccessAt)); m.put("lastSendFailAt", text(s.lastImageSendFailureAt)); m.put("sendSuccessCount", s.imageSendSuccessCount); m.put("sendFailCount", s.imageSendFailureCount); return m; }
    private Map<String, Object> workInfo(HealthSnapshot s) { Map<String, Object> m = new LinkedHashMap<String, Object>(); m.put("lastImageDetectedAt", text(s.lastImageDetectedAt)); m.put("lastImageSentAt", text(s.lastImageSendSuccessAt)); return m; }
